...
# Extends the ckanext-contact plugin of Natural History Museum in London, UK
...
blueprint = Blueprint(name='opendata_theme_contact', import_name=__name__, url_prefix='/contact')
...
def form():
    ...
    if toolkit.request.method == 'POST':
        ...
        try:
            extra_vars['data']['user_name'] = (
                toolkit.c.userobj.fullname or toolkit.c.userobj.name
            )
            extra_vars['data']['user_email'] = toolkit.c.userobj.email
